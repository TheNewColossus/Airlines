# Airlines
This **Data Enginnering Project** is a data pipeline which grabs data from an airlines api, stores it in druid and makes it accessible to grafana visualisation software.
